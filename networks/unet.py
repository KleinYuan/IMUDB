# From: https://github.com/PyTorchLightning/pytorch-lightning/blob/master/pl_examples/domain_templates/unet.py
...
class UNet(nn.Module):
    ...
    def __init__(self, num_classes: int = 19, input_channel: int = 3, num_layers: int = 5, features_start: int = 64, bilinear: bool = False):
        """
        Args:
            num_classes: Number of output classes required (default 19 for KITTI dataset)
            input_channel: input image channels
        ...
        layers = [DoubleConv(input_channel, features_start)]
